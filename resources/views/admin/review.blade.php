        ...
        <div class="d-flex justify-content-center">
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li><a href="{{ route('admin.reviews') }}"class="active">Review</a></li>
        ...
        <section>
            ...
            <section class="users">
                <div class="box-container">
                    ...
                    <div class="box">
                        <p> Reviewer Name: <span>{{ $review->reviewer_name }}</span> </p>
                        <p> Review Text: <span>{{ $review->review_text }}</span> </p>
                        <p> User ID: <span>{{ $review->user_id }}</span> </p>
                       
                       
                        <a href="{{ route('admin.reviewDelete', $review->review_id) }}" onclick="return confirm('Delete this review?');" class="delete-btn">Delete</a>
